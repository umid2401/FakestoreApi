...
export default function Sidebar() {
  ...
  return (
    <section className="">
      ...
      { !isLoginPage&&(
        loading&&(
          <aside className="bg-white shadow-sm inset-0 z-50 my-4 ml-4 h-full w-72 rounded-xl transition-transform duration-300 xl:translate-x-0 border border-blue-gray-100 flex flex-col  ">
